...
#define TCP_MODUL		//Флажок включения модуля
...
///Внешний обработчик вызываемый при установлении соединения в TCP сессии
#define TCP_OPEN_HANDLER() DEBUG_MSG("TCP_OPEN_HANDLER")
///Внешний обработчик вызываемый при получении данных в TCP сессии
#define TCP_HANDLER_DATA() http_parsing()
///Внешний обработчик вызываемый при закрытии TCP сессии
