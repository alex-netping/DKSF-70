...
#define NIC_RAM_START RTL8019_TX_START // LBS 21.05.2012
///Размер динамической области в страницах
#define NIC_RAM_SIZE (RTL8019_RX_START - RTL8019_TX_START) // Tx buffer range - LBS 21.05.2012
...
#define NIC_SEND_PACKET(addr,len) do { mac236x_send_packet(addr,len); led_blink(CPU_LED_N, TRAFFIC_LED_TIME); } while(0)
